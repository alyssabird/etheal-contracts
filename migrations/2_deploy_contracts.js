...
module.exports = function(deployer) {
    return deployer.then(function(){
        ...
        // then Normal Sale
        return deployer.deploy(NormalSale,EthealController.address,dateStart,dateEnd,web3.toWei(0.1, "ether"),1000,web3.toWei(0.1, "ether"),120*60*60,web3.toWei(0.1, "ether"),Wallet);
    }).then(function(){
        ...
        // set crowdsale
        return (EthealController.at(EthealController.address)).setCrowdsaleTransfer(NormalSale.address,web3.toBigNumber(web3.toWei(0.1,"ether")).mul(1000));
    }).then(function(){
        ...
        // set whitelist
        return (NormalSale.at(NormalSale.address)).setWhitelist(EthealWhitelist.address, web3.toWei(0.1, "ether"));
    }).then(function(){
